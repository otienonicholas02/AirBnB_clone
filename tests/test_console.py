#!/usr/bin/python3
"""Defines unittests for console.py and all classes. """
...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unittests for testing HBNB command prompt interpreter."""

    def test_commandprompt(self):
        self.assertEqual("(hbnb) ", HBNBCommand.prompt)


class TestHBNBCommand_exit(unittest.TestCase):
    """Unittests for testing the exiting command."""

    def test_quittoexit(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertTrue(HBNBCommand().onecmd("quit"))

    def test_EOFtoexit(self):
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_helptoquit(self):
        var = "Function for the quit commmand to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help quit"))
            self.assertEqual(var, output.getvalue().strip())

    def test_helptoshow(self):
        x = ("Show the string representation of a given id.")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help show"))
            self.assertEqual(x, output.getvalue().strip())

    def test_helptoEOF(self):
        var = "Command EOF to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help EOF"))
            self.assertEqual(var, output.getvalue().strip())

    def test_helptodestroy(self):
        var = ("Function to delete a class instance of a given id.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_helptocount(self):
        var = ("Count the number of instances of a given class.")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help count"))
            self.assertEqual(var, output.getvalue().strip())

    def test_helptoupdate(self):
        var = ("Update a class instance of a given id.")
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_create(unittest.TestCase):
    """Unittests for testing the create command."""
    ...
    def test_ifinvalid_class(self):
        correct = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create MyModel"))
            self.assertEqual(correct, output.getvalue().strip())

    def test_ifmissing_class(self):
        correct = "** class name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create"))
            self.assertEqual(correct, output.getvalue().strip())

    def test_ifinvalid_syntax(self):
...
class TestHBNBCommand_show(unittest.TestCase):
    ...
    def test_no_instance_found_space(self):
    ...
    def test_no_instance_found_dot(self):
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests for testing destroy command."""
    ...
    def test_idinvalid_class_destroy(self):
        correct = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_ifinvalidid_space_destroy(self):
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_ifinvalidid_dot_destroy(self):
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_ifmissing_class_destroy(self):
        correct = "** class name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_ifmissingid_space_destroy(self):
        correct = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_ifmissingid_dot_destroy(self):
        correct = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_objects_dot_destroy(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_all(unittest.TestCase):
    ...
    def test_invalid_class_all(self):
        correct = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_objects_space_all(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
    ...
    def test_single_object_dot(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
...
class TestHBNBCommand_update(unittest.TestCase):
    ...
    def test_forupdating_missing_id_space(self):
        correct = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_forupdating_missing_id_dot(self):
        correct = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_forupdating_invalid_id_space(self):
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_forupdating_invalid_id_dot(self):
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_forupdating_missing_attribute_name_space(self):
    ...
    def test_forupdating_missing_attribute_name_dot(self):
        correct = "** attribute name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testId = output.getvalue().strip()
    ...
    def test_forupdating_missing_attribute_value_space(self):
    ...
    def test_forupdating_missing_attribute_value_dot(self):
        correct = "** value missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
    ...
    def test_forupdating_valid_str_attribute_space(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
    ...
    def test_forupdating_valid_str_attribute_dot(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
    ...
    def test_forupdating_valid_int_attribute_space(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
    ...
    def test_forupdating_valid_int_attribute_dot(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tId = output.getvalue().strip()
    ...
    def test_forupdating_valid_float_attribute_space(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
    ...
    def test_forupdating_valid_float_attribute_dot(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tId = output.getvalue().strip()
    ...
    def test_forupdating_valid_dict_space(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
        testCmd = "update BaseModel {} ".format(testId)
    ...
    def test_forupdating_valid_dict_dot(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
        testCmd = "BaseModel.update({}".format(testId)
    ...
    def test_forupdating_valid_dict_int_space(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "update Place {} ".format(testId)
    ...
    def test_forupdating_valid_dict_int_dot(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "Place.update({}, ".format(testId)
    ...
    def test_forupdating_valid_dict_float_space(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "update Place {} ".format(testId)
    ...
    def test_forupdating_valid_dict_float_dot(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "Place.update({}, ".format(testId)
...
class TestHBNBCommand_count(unittest.TestCase):
    """Unittests for testing the count command."""
    ...
    def test_tocount_invalid_object(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_tocount_invalid_class(self):
        with patch("sys.stdout", new=StringIO()) as output:
